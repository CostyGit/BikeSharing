...
def get_filters():
    ...
    """
    while True:
        day = str(input('Which day? Please type a day Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday. Or type "All" for no day filter.').lower().strip())
